...
public class Intersection implements Comparable<Intersection>  {
	...
	public void adjustIntersection(Direction dir) {
		HashMap<String, Integer> changes = dir.getChanges();
		this.avenue += changes.get("avenue");
	...
	public static void main(String[] args) {
		...
		Intersection corner2 = new Intersection(23, 6); 
		...
		if(corner1.equals(corner2 ) == false ) {
				...
				System.out.println("Corners are equal.");
		}
